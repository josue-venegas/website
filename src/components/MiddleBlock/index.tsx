...
import { MiddleBlockSection, Content, ContentWrapper, CardThumbnail, CardContainer, CardTitle, CardDescription, CardTagsContainer, CardTag, CardButtonsContainer, CardButton, CardContent } from "./styles";
    ...
    <CardContainer>
      ...
      <CardContent>
        ...
        <CardButtonsContainer>
          {liveURL && (
            <CardButton href={liveURL} target="_blank" rel="noopener noreferrer">
              {t("Live Demo")}
              <svg
          ...
          {sourceURL && (
            <CardButton href={sourceURL} target="_blank" rel="noopener noreferrer">
              {t("Source Code")}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="12"
          ...
          {picturesURL && (
            <CardButton href={picturesURL} target="_blank" rel="noopener noreferrer">
              {t("Screenshots")}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="12"
